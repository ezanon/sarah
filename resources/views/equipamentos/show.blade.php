    ...
    <div class="row g-4">
        ...
        <div class="mb-3 mt-3">
            @if($equipamento->ativo)
                <span class="badge bg-success fs-6 px-3 py-2 text-white">✅Ativo</span>
            @else
                <span class="badge bg-danger fs-6 px-3 py-2 text-white">
                    Inativo 
                    @if($equipamento->motivo_inativacao)
                        — {{ ucfirst($equipamento->motivo_inativacao) }}
                    @endif
                </span>
            @endif
        </div>
            ...
            <div class="card shadow-sm">
                <div class="card-body">
                    ...
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item"><strong>Valor:</strong> {{ $equipamento->valor_formatado }}</li>
